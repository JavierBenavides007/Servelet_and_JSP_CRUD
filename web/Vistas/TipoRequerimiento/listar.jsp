...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Listado de Tipo de Requerimiento</h1>
            <table class="table">
                <thead>
                    <tr>
                        <th>Nombre Tipo Requerimiento</th>
                        <th>Descripcion</th>
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <a href="TipoRequerimientoControlador?accion=actualizar&id=<%=tp.getId() %>" class="btn btn-danger">Actualizar</a>
